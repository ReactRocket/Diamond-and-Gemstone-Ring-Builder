      ...
      <div className="mx-auto w-[95%] px-24">
        ...
        <div className=" p-20  min-h-[50vh] w-full">
          <div className=" flex min-h-[70vh] w-full">
            <div className="h-full  w-[40%]  p-2 flex gap-1   ">
              <div className=" space-y-5  w-[19%] flex flex-col gap-4">
              ...
              {/* main img */}
              <div className="h-full w-[71%] border">
                <img
                  className="h-full w-full object-cover"
                  src={ring1}
                  alt="product image"
            ...
            <div className="h-full w-[60%]">
              ...
              <div className="grid grid-cols-6 min-h-24  w-full gap-5 mt-5 ">
                {shapes_array.map((val, index) => {
                  return (
                    <button
                      className="w-24  gap-10  border border-violet-500 hover:bg-violet-200 focus:bg-[#8357DB] focus:text-white  flex justify-center items-center  "
                      key={index}
                    >
              ...
              <div className=" mt-4 h-full w-3/4">
                ...
                <div className="h-10 w-full flex  justify-start items-center">
                  <button className="flex gap-3 justify-center items-center">
                    ...
                    <span className="border-b-2 border-transparent hover:border-b-purple-500 text-[#7646D7] ">Share</span>
                  </button>
                </div>
              </div>
            </div>
